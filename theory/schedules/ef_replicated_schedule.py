...
from imlmlib.information import gen_hessians, compute_full_observed_information, compute_observed_information
...
filename = "save_data/ef_schedule_blockreplicated.json"
...
plt.savefig("images/information_block_repet.pdf")
plt.show()
...
# plt.savefig("images/replicated.pdf")
