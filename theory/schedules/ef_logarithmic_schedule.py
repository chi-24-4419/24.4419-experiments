...
def play_logarithmic_schedule(population_model, N):
    times = numpy.logspace(0, numpy.log10(100 * 86800), N)
...
if GEN_DATA:
    ...
    play_schedule = play_logarithmic_schedule
    ...
    filename = "save_data/ef_schedule_logarithmic.json"
    ...
    with open("save_data/ef_schedule_logarithmic.json", "r") as _file:
        json_data = json.load(
            _file,
        )
...
fischer_information, agg_data = compute_observed_information(
    [ALPHA_TRUE, BETA_TRUE],
    recall_array,
    observed_hessians,
...
plt.savefig("images/logarithmic.pdf")
